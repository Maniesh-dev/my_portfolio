...
const Navbar = () => {
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 text-center border rounded-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-50 items-center justify-between px-4 py-2 gap-4 hidden md:flex">
